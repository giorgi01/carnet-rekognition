...
auto_page_n = lambda \
        nth_page: f"https://api2.myauto.ge/ka/products?TypeID=0&ForRent=&Mans=&CurrencyID=3&MileageType=1&Page={nth_page}"
...
async def parse_images(dir_name):
...
def parse_and_save_to(where_to_save):
    asyncio.run(parse_images(where_to_save))
